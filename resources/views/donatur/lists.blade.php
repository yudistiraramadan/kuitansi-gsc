<x-main>
    ...
    <div class="card">
        <div class="card-body">
            <a href="{{ route('create.donatur') }}">
                <button class="btn btn-primary mb-2">Tambah</button>
            </a>&nbsp;&nbsp;
            <div class="table-responsive table-container">
                <table class="table table-hover table-bordered" id="tb-donatur">
                    <thead>
                        <tr>
                            <th scope="col" style="text-align:left;">No.</th>
                            <th scope="col">Nama</th>
                            <th scope="col">Alamat</th>
                            <th style="text-align: left;" scope="col">WhatsApp</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($donaturs as $donatur)
                            <tr>
                                ...
                                <td style="text-align: left;">{{ $donatur->phone }}</td>
                                <td>{{ $donatur->kecamatan }}</td>
                                <td>
                                    <div class="d-flex" style="justify-content: center; align-items:center;">
                                        <a data-toggle="tooltip" data-placement="top" title="Edit"
                                            href="{{ route('edit.donatur', $donatur->id) }}" data-original-title="Edit">
                                        ...
                                        <a href="javascript:void(0)" data-id="{{ $donatur->id }}"
                                            class="delete-donatur" name="delete" data-toggle="tooltip"
                                            data-placement="top" title="Hapus" data-id="4"
                                            data-original-title="Hapus"><svg width="22" height="22"
                                        ...
                                        <a href="{{ route('detail.donatur', $donatur->id) }}" class="print-kuitansi"
                                            name="print" data-toggle="tooltip" data-placement="top" title="Detail"
                                            data-id="4" data-original-title="Detail">
                                            <svg fill="#03AED2" height="22px" width="22px" version="1.1"
                                                id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 472.615 472.615"
                                                xml:space="preserve" stroke="#03AED2">
...
<script>
    let table = new DataTable('#tb-donatur');
</script>
...
<script>
    $(document).on('click', '.delete-donatur', function() {
        id = $(this).data('id');
        Swal.fire({
            title: 'Hapus donatur?',
            text: "Apakah anda yakin ingin menghapus donatur!",
            icon: 'warning',
