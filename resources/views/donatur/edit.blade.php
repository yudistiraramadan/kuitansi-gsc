<x-main>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('update.donatur', $donatur->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" min="0"
                                ...
                                id="phone" name="phone" value="{{ $donatur->phone }}">
                            @error('phone')
                                <div class="text text-danger">
                                    {{ $message }}
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat">{{ $donatur->alamat }}</textarea>
                            @error('alamat')
                                <div class="text text-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gender" id="laki-laki"
                                    value="Laki-laki" {{ $donatur->gender == 'Laki-laki' ? 'checked' : '' }}>
                        ...
                        <div class="col-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gender" id="perempuan"
                                    value="Perempuan" {{ $donatur->gender == 'Perempuan' ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-4">
                        ...
                        <select class="form-select" name="kecamatan" id="kecamatan">
                            ...
                            <option value="{{ $donatur->kecamatan }}">{{ $donatur->kecamatan }}</option>
