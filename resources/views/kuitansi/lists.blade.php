                            ...
                            @if (Auth::user()->role_id == 1)
                                <div class="d-flex" style="justify-content: center; align-items:center;">
                                    <a data-toggle="tooltip" data-placement="top" title="Edit"
                                        href="{{ route('edit.kuitansi', $kuitansi->id) }}" data-original-title="Edit">
                                    ...
                                    <a href="javascript:void(0)" data-id="{{ $kuitansi->id }}" class="delete-kuitansi"
                                    ...
                                    <a href="{{ route('print.kuitansi', $kuitansi->id) }}" data-id=""
                                        class="print-kuitansi" name="print" data-toggle="tooltip" data-placement="top"
                                        title="Print" data-id="4" data-original-title="Print"><svg width="22"
                                            height="22" fill="#03AED2" viewBox="0 0 24 24"
