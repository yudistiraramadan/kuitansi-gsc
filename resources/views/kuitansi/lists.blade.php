                    ...
                    <tbody>
                        ...
                        @foreach ($kuitansis as $kuitansi)
                            <tr>
                                ...
                                <td>{{ $kuitansi->nama_donatur }}</td>
                                @if (Auth::user()->role_id == 1)
                                    <td>{{ $kuitansi->nama_user }}</td>
                                @endif
                                ...
                                <td style="text-align: center;">
                                    @if (Auth::user()->role_id == 1)
                                        <div class="d-flex" style="justify-content: center; align-items:center;">
                                            <a data-toggle="tooltip" data-placement="top" title="Edit"
                                                href="{{ route('edit.kuitansi', $kuitansi->id) }}"
                                            ...
                                            <a href="javascript:void(0)" data-id="{{ $kuitansi->id }}"
                                                class="delete-kuitansi" name="delete" data-toggle="tooltip"
                                            ...
                                            <a href="{{ route('print.kuitansi', $kuitansi->id) }}" data-id=""
                                                class="print-kuitansi" name="print" data-toggle="tooltip"
                                                data-placement="top" title="Print" data-id="4"
                                                data-original-title="Print"><svg width="22" height="22"
                                                    fill="#03AED2" viewBox="0 0 24 24"
                                                    xmlns="http://www.w3.org/2000/svg" stroke="#03AED2">
                                    ...
                                    @elseif(Auth::user()->role_id == 2)
                                        <a href="{{ route('print.thermal', $kuitansi->id) }}" class="btn btn-danger">
                                            Print Kuitansi
                                        </a>

                                        {{-- <a href="javascript:void(0)" data-id="{{ $kuitansi->id }}"
                                            class="print-thermal" name="print_thermal" data-toggle="tooltip"
                                            data-placement="top" title="Hapus" data-id="4"
                                            data-original-title="Hapus"><svg width="22" height="22"
